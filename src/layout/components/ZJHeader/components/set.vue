<template>
  <div class="ZJHeaderToolsBox" @click="open('openRight')">
    <ZJSvgIcons icon="set"></ZJSvgIcons>
  </div>
  <Transition name="mask">
    <div class="modal" v-show="showRight" ref="setMaskEl"></div>
  </Transition>
  <transition name="showSetRight">
    <div class="user-main" v-show="showRight" ref="setMainEl">
      <div class="header">
...
function closeRightAndMask(e) {
  ...
  if (isOutside && showRight.value && isInMask) {
    close('closeRight')
  }
}
/**
